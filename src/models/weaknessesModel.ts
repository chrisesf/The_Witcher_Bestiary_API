...
class WeaknessDAO {
  ...
  static async weaknessUpdate(
    weakness: Weakness,
    creatureId: number,
    itemId: number,
  ) {
    const sql =
      "UPDATE weakness SET item_id = $1 WHERE creature_id = $2 AND item_id = $3"
  ...
  static async weaknessList() {
    const sql =
      "SELECT item_id, creature_id, created_at, updated_at FROM weakness"
  ...
  static async getWeaknessById(id: number) {
    const sql =
      "SELECT item_id, creature_id, created_at, updated_at FROM weakness WHERE creature_id = $1"
  ...
  static async getEffectivenessById(id: number) {
    const sql =
      "SELECT item_id, creature_id, created_at, updated_at FROM weakness WHERE item_id = $1"
